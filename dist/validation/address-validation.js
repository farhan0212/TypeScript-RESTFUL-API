...
AddressValidation.CREATE = zod_1.z.object({
    ...
    street: zod_1.z.string().min(3).max(100).optional(),
    city: zod_1.z.string().min(3).max(100).optional(),
    province: zod_1.z.string().min(3).max(100).optional(),
    country: zod_1.z.string().min(3).max(100),
    postal_code: zod_1.z.string().min(3).max(12),
});
