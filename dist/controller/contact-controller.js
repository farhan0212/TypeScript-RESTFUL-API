...
class ContactController {
    ...
    static get(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const contacttId = Number(req.params.contactId);
                const response = yield contact_service_1.ContactService.get(req.user, contacttId);
                res.status(200).json({
                    data: response,
                });
            }
    ...
    static delete(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const contacttId = Number(req.params.contactId);
                yield contact_service_1.ContactService.delete(req.user, contacttId);
                res.status(200).json({
                    data: "ok",
                });
            }
