...
class UserService {
    static register(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalUserWithUsername = yield database_1.prismaClient.user.count({
                where: {
            ...
            registerRequest.password = (yield bcryptjs_1.default.hash(registerRequest.password, 10));
    ...
    static login(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new response_error_1.ResponseError(401, "username of password is wrong");
            }
            const isPasswordValid = yield bcryptjs_1.default.compare(loginRequest.password, user.password);
            if (!isPasswordValid) {
                throw new response_error_1.ResponseError(401, "username of password is wrong");
            }
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (updateRequest.password) {
                user.password = yield bcryptjs_1.default.hash(updateRequest.password, 10);
            }
